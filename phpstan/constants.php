 ...
 * 本体 phpstan/constants.php（設定・CMS 定数）と ablogcms/php/config/cli_constants.php
 * （リクエスト定数）の連結。値は型を持つダミーで、値の動的性は dynamic-constants.neon が担う。
 */

// --- from phpstan/constants.php ---
define('DOMAIN', '');
define('DOMAIN_BASE', '');
...
// --- from ablogcms/php/config/cli_constants.php ---
if (!defined('BID')) {
    define('BID', 1);
}
if (!defined('DATE')) {
